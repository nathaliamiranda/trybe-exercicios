...
function criaButton(string) {
  ...
  chamaPai.appendChild(buttonFriday);
  buttonFriday.innerHTML = string;
}
criaButton('Sexta-feira');
...
let efeitoZoom = document.querySelector('#days');
function darZoom(event) {
  event.target.style.fontSize = '30px';
}
efeitoZoom.addEventListener('mouseover', darZoom);

function tirarZoom(event) {
  event.target.style.fontSize = '20px';
}
efeitoZoom.addEventListener('mouseout', tirarZoom);

//  7. Implemente uma função que adiciona uma tarefa personalizada ao calendário. A função deve receber como parâmetro a string com o nome da tarefa (ex: "cozinhar") e criar dinamicamente um elemento com a tag <span> contendo a tarefa.
// O elemento criado deverá ser adicionado como filho/filha da tag <div> que possui a classe "my-tasks" . 
// chamar pai e criar filho
function criarTarefa(tarefa) {
  const chamaDivPai = document.querySelector('.my-tasks');
  const filhoDaDiv = document.createElement('span');
  chamaDivPai.appendChild(filhoDaDiv);
  filhoDaDiv.innerText = tarefa;
}
criarTarefa('cozinhar');
// 8. Implemente uma função que adiciona uma legenda com cor para a tarefa criada no exercício anterior. Esta função deverá receber como parâmetro uma string ("cor") e criar dinamicamente um elemento de tag <div> com a classe task .
// O parâmetro cor deverá ser utilizado como cor de fundo da <div> criada.
// O elemento criado deverá ser adicionado como filho/filha da tag <div> que possui a classe "my-tasks" . 
function adicionaLegendaComCor() {
  const chamaDivPai = document.querySelector('.my-tasks');
  const segundoFilhoDaDiv = document.createElement('div');
  chamaDivPai.appendChild(segundoFilhoDaDiv);
  segundoFilhoDaDiv.className = 'task';
  segundoFilhoDaDiv.style.backgroundColor = 'pink';

}
adicionaLegendaComCor();

// 9. Implemente uma função que adiciona um evento que, ao clicar no elemento com a tag <div> referente a cor da sua tarefa, atribua a este elemento a classe task selected , ou seja, quando sua tarefa possuir a classe task selected , ela estará selecionada.
// Ao clicar novamente no elemento, a sua classe deverá voltar a ser somente task , ou seja, esta tarefa está deixando de ser uma tarefa selecionada. 
let segundoFilhoDaDiv = document.querySelector('.task');
function clickNaTarefa(event) {
  event.target.classList.toggle('selected');
  // tira e coloca a classe, alternando
}
segundoFilhoDaDiv.addEventListener('click', clickNaTarefa);
...
let chamaClasse = document.querySelector('#days');
function atribuiCor(event) {
  event.target.style.backgroundColor = 'blue';
}
chamaClasse.addEventListener('click', atribuiCor);
