...
// console.log(temperatureInFahrenheit(toFahrenheit(getMarsTemperature())));
// console.log(greet(toFahrenheit(getMarsTemperature())));
// sendMarsTemperature(greet(toFahrenheit(getMarsTemperature())));